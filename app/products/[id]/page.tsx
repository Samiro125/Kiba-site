...
const products = [
  {
    ...
    prices: [
      { duration: "1 day", amount: "$11.99", originalAmount: "$19.99" },
      { duration: "1 week", amount: "$28.99", originalAmount: "$49.99", popular: true },
      { duration: "1 month", amount: "$60.99", originalAmount: "$99.99" },
      { duration: "lifetime", amount: "$250.99", originalAmount: "$399.99", popular: true, bestValue: true },
    ],
    rating: 5,
    totalReviews: 1248,
  ...
  },
  {
    ...
    prices: [
      { duration: "1 day", amount: "$11.99", originalAmount: "$19.99" },
      { duration: "1 week", amount: "$22.99", originalAmount: "$39.99", popular: true },
      { duration: "1 month", amount: "$40.99", originalAmount: "$69.99" },
      { duration: "lifetime", amount: "$250.99", originalAmount: "$399.99", popular: true, bestValue: true },
    ],
    rating: 5.0,
    totalReviews: 723,
  ...
  },
  {
    ...
    prices: [
      { duration: "3 day", amount: "$12.99", originalAmount: "$21.99" },
      { duration: "1 week", amount: "$18.99", originalAmount: "$31.99", popular: true },
      { duration: "1 month", amount: "$35.99", originalAmount: "$59.99" },
      { duration: "lifetime", amount: "$150.99", originalAmount: "$249.99" },
    ],
    rating: 4.8,
    totalReviews: 1156,
