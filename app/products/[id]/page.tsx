...
const products = [
  {
    ...
    prices: [
      { duration: "1 day", amount: "$9.99", originalAmount: "$19.99", checkoutUrl: "https://buy.stripe.com/8x27sN3v1fRpg633TZcs80D" },
      { duration: "3 day", amount: "$17.99", originalAmount: "$29.99", checkoutUrl: "https://buy.stripe.com/fZu14p2qX9t1075duzcs80E" },
      { duration: "7 day", amount: "$21.99", originalAmount: "$49.99", popular: true, checkoutUrl: "https://buy.stripe.com/fZu28tfdJ34D6vt4Y3cs80F" },
      { duration: "30 day", amount: "$57.99", originalAmount: "$99.99", checkoutUrl: "https://buy.stripe.com/9B65kF5D9bB95rp8afcs80G" },
      { duration: "lifetime", amount: "$119.99", originalAmount: "$399.99", popular: true, bestValue: true, checkoutUrl: "https://buy.stripe.com/8x214p5D9fRp6vt76bcs80H" },
    ],
    rating: 5,
    totalReviews: 1248,
  ...
  },
  {
    ...
    prices: [
      ...
      { duration: "1 week", amount: "$21.99", originalAmount: "$31.99", popular: true, checkoutUrl: "https://buy.stripe.com/7sY8wR9TpfRp7zxduzcs80i" },
      { duration: "1 month", amount: "$57.99", originalAmount: "$59.99", checkoutUrl: "https://buy.stripe.com/9B69AV7LhcFd5rpfCHcs80j" },
      { duration: "lifetime", amount: "$119.99", originalAmount: "$249.99", bestValue: true, checkoutUrl: "https://buy.stripe.com/9B6dRb3v134D2fd9ejcs80k" },
    ],
    rating: 4.8,
    totalReviews: 1156,
  ...
  },
  {
    ...
    prices: [
      { duration: "1 week", amount: "$21.99", originalAmount: "$24.99", popular: true },
      { duration: "1 month", amount: "$57.99", originalAmount: "$49.99" },
      { duration: "lifetime", amount: "$119.99", originalAmount: "$99.99", bestValue: true },
    ],
    rating: 4.9,
    totalReviews: 876,
  ...
  },
  {
    ...
    prices: [
      { duration: "1 day", amount: "$9.99", originalAmount: "$24.99", checkoutUrl: "https://buy.stripe.com/cNi5kF5D90Wv1b9duzcs80p" },
      { duration: "1 week", amount: "$21.99", originalAmount: "$44.99", popular: true, checkoutUrl: "https://buy.stripe.com/4gM4gBe9F48HaLJeyDcs80q" },
      { duration: "1 month", amount: "$57.99", originalAmount: "$89.99", checkoutUrl: "https://buy.stripe.com/00wfZj7Lh9t19HF2PVcs80r" },
      { duration: "lifetime", amount: "$119.99", originalAmount: "$249.99", popular: true, bestValue: true, checkoutUrl: "https://buy.stripe.com/4gM9AV8Pl0Wv6vt3TZcs80s" },
    ],
    rating: 5.0,
    totalReviews: 892,
    color: "from-blue-600 to-blue-900",
  ...
  },
  {
    ...
    prices: [
      ...
      { duration: "1 week", amount: "$21.99", originalAmount: "$34.99", popular: true, checkoutUrl: "https://buy.stripe.com/14A28t0iPbB94nlgGLcs80u" },
      { duration: "1 month", amount: "$57.99", originalAmount: "$69.99", checkoutUrl: "https://buy.stripe.com/bJe5kF9Tp0Wvg63eyDcs80v" },
  ...
  },
  {
    ...
    prices: [
      ...
      { duration: "1 week", amount: "$21.99", originalAmount: "$34.99", popular: true, checkoutUrl: "https://buy.stripe.com/9B67sN1mT0Wv2fdduzcs807" },
      { duration: "1 month", amount: "$57.99", originalAmount: "$44.99", checkoutUrl: "https://buy.stripe.com/dRm14p0iPfRp7zx2PVcs808" },
      { duration: "lifetime", amount: "$119.99", originalAmount: "$99.99", popular: true, bestValue: true, checkoutUrl: "https://buy.stripe.com/5kQcN7fdJ9t17zx1LRcs809" },
    ],
    rating: 5.0,
    totalReviews: 1543,
  ...
  },
  {
    ...
    prices: [
      ...
      { duration: "1 week", amount: "$21.99", originalAmount: "$49.99", popular: true, checkoutUrl: "https://buy.stripe.com/5kQ6oJd5BgVt8DBaincs80y" },
      { duration: "1 month", amount: "$57.99", originalAmount: "$99.99", checkoutUrl: "https://buy.stripe.com/cNifZjc1x8oXg630HNcs80z" },
