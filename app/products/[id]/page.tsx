                  ...
                  onClick={() => {
                    ...
                    if (isArcDelta || isArcFlo || shopifyProducts.includes(actualId)) {
                      ...
                      if (actualId === "valorant") {
                        ...
                        // Accounts use different pricing structure
                        const accountUrls: Record<number, string> = {
                          0: "https://xyaniu.com/cart/56652594446680:1", // arc raiders nfa
                          1: "https://xyaniu.com/cart/56652594479448:1", // rust nfa
                          2: "https://xyaniu.com/cart/56652594512216:1", // bf6 nfa
                        }
                        window.open(accountUrls[selectedPlan] || accountUrls[0], "_blank")
                        return
                      }
                          ...
                          : actualId === "marvel-rivals"
                            ...
                            : actualId === "fivem"
                              ...
                              : actualId === "temp-spoofer"
                                ...
                                : actualId === "accounts"
                                  ? [
                                      "https://www.fanbasis.com/agency-checkout/antweaks/l5JBV", // Arc NFA Account
                                      "https://www.fanbasis.com/agency-checkout/antweaks/mQKDn", // Rust NFA Account
                                      "https://www.fanbasis.com/agency-checkout/antweaks/nrLEP", // BF6 NFA Account
                                    ][selectedPlan]
                                  : actualId === "valorant"
                                    ? [
