      ...
      <main className="container mx-auto px-6 py-16 pt-24">
        ...
        <div className="max-w-3xl mx-auto space-y-4 mb-16">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="border border-white/10 rounded-lg bg-zinc-900/50 overflow-hidden transition-all hover:border-red-500/30"
            >
              <button
                onClick={() => setOpenIndex(openIndex === index ? null : index)}
                className="w-full px-6 py-5 flex items-center justify-between text-left transition-colors hover:bg-zinc-800/50"
              >
        ...
        {/* CTA Section */}
        <div className="max-w-2xl mx-auto text-center bg-zinc-900 border border-red-500/20 rounded-lg p-8">
