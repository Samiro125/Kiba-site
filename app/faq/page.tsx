      ...
      <main className="container mx-auto px-6 py-16 pt-24">
        ...
        <div className="max-w-3xl mx-auto space-y-4 mb-16">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="border border-white/10 rounded-lg bg-zinc-900/50 overflow-hidden transition-all duration-500 hover:border-white/40 hover:shadow-lg hover:shadow-white/5 hover:-translate-y-1 animate-fade-in group/faq"
        ...
        {/* CTA Section */}
        <div className="max-w-2xl mx-auto text-center bg-zinc-900 border border-white/20 rounded-lg p-8 hover:border-white/50 transition-all duration-500 hover:shadow-xl hover:shadow-white/10 hover-border-glow">
          ...
          <Link href="https://discord.com/invite/AadcxjnkAR" target="_blank" rel="noopener noreferrer">
            <Button className="bg-white hover:bg-zinc-200 text-black font-medium px-8 py-3 text-base transition-all flex items-center gap-2 mx-auto">
