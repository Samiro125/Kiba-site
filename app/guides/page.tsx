                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-4">
                        ...
                        <Link href="https://telegra.ph/ANCIENT-FAQ-EU-07-20" target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-4">
                        ...
                        <Link href="https://telegra.ph/INJECTION-07-21-4" target="_blank" rel="noopener noreferrer">
                          <Button className="bg-red-600 hover:bg-red-700 text-white">
                            <svg className="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-4">
                        ...
                        <Link href="https://loader.red/instructions.html" target="_blank" rel="noopener noreferrer">
                          <Button className="bg-red-600 hover:bg-red-700 text-white">
                            <svg className="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path
                                strokeLinecap="round"
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-4">
                        ...
                        <Link href="https://loader.red/" target="_blank" rel="noopener noreferrer">
                          <Button className="bg-red-600 hover:bg-red-700 text-white">
                            <svg className="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path
                                strokeLinecap="round"
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="bg-zinc-800 border border-zinc-700 rounded-lg p-4">
                            ...
                            <div className="mt-4">
                              <Link href="https://speedware.store/customers" target="_blank" rel="noopener noreferrer">
                                <Button className="bg-red-600 hover:bg-red-700 text-white">
                                  <svg className="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path
                                      strokeLinecap="round"
